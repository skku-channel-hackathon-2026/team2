-- T5 잡기 파이프라인 데모/테스트용 시드. T1(계정 연결)·T2(매칭)이 아직 없으므로
-- "이미 밥약이 성사되어 만남 완료를 기다리는 상태"를 여기서 직접 만든다.
--
-- 사용법:
...
INSERT INTO users (id, channel_manager_id, nickname, is_senior, created_at) VALUES
  ('senior-1', 'm-senior-1', '김선배', 1, '2026-09-19T00:00:00.000Z'),
  ('senior-2', 'm-senior-2', '이선배', 1, '2026-09-19T00:00:00.000Z');

INSERT INTO users (id, channel_user_id, nickname, created_at) VALUES
  ('junior-1', 'u-junior-1', '코딩초보', '2026-09-19T00:00:00.000Z');

INSERT INTO encounters
  (id, junior_id, category_id, title, meet_type, max_seniors, status, slot_start, slot_end, place, created_at)
VALUES
